...
@Component({
  selector: 'archived-answer-detail',
  template: `
...
`]
    ...
    export class ArchivedAnswerDetailComponent implements OnInit{
      editedComment: string;
      editedAnswerStatus: string;

    constructor(@Inject(MAT_DIALOG_DATA) public data: any, public dialogRef: MatDialogRef<ArchivedAnswerDetailComponent>, private answerService: AnswerService, private router: Router,
